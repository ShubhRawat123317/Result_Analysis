...
--Add new column in table partywise_results to get the Party Alliance as NDA, I.N.D.I.A and OTHER
...
--party alliance (NDA, I.N.D.I.A, or OTHER) won total seats across all states
...
WHERE s.State = 'Maharashtra' AND cr.Constituency_Name = 'Thane';

--distribution of EVM votes versus postal votes for candidates in a specific constituency
SELECT 
    cd.Candidate,cd.Party,cd.EVM_Votes,cd.Postal_Votes,cd.Total_Votes,cr.Constituency_Name
FROM 
    constituencywise_details cd
JOIN 
    constituencywise_results cr ON cd.Constituency_ID = cr.Constituency_ID
WHERE 
    cr.Constituency_Name = 'Thane'
...
--total number of seats won by each party alliance (NDA, I.N.D.I.A, and OTHER) in each state for the India Elections 2024
SELECT 
